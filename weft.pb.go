...
func (HealthProbe_Type) EnumDescriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{401, 0}
}
...
type GetClusterInfoResponse struct {
	...
	ControlPlaneHostUuids []string `protobuf:"bytes,3,rep,name=control_plane_host_uuids,json=controlPlaneHostUuids,proto3" json:"control_plane_host_uuids,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *GetClusterInfoResponse) GetControlPlaneHostUuids() []string {
	if x != nil {
		return x.ControlPlaneHostUuids
	}
	return nil
}
...
type HostInfo struct {
	...
	DriverVersions map[string]string `protobuf:"bytes,16,rep,name=driver_versions,json=driverVersions,proto3" json:"driver_versions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *SchedulingRuleInfo) Reset() {
	*x = SchedulingRuleInfo{}
	mi := &file_weft_proto_msgTypes[403]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SchedulingRuleInfo) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{403}
}
...
func (x *ListSchedulingRulesRequest) Reset() {
	*x = ListSchedulingRulesRequest{}
	mi := &file_weft_proto_msgTypes[404]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSchedulingRulesRequest) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{404}
}
...
func (x *ListSchedulingRulesResponse) Reset() {
	*x = ListSchedulingRulesResponse{}
	mi := &file_weft_proto_msgTypes[405]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSchedulingRulesResponse) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{405}
}
...
func (x *CreateSchedulingRuleRequest) Reset() {
	*x = CreateSchedulingRuleRequest{}
	mi := &file_weft_proto_msgTypes[406]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateSchedulingRuleRequest) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{406}
}
...
func (x *CreateSchedulingRuleResponse) Reset() {
	*x = CreateSchedulingRuleResponse{}
	mi := &file_weft_proto_msgTypes[407]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateSchedulingRuleResponse) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{407}
}
...
func (x *UpdateSchedulingRuleRequest) Reset() {
	*x = UpdateSchedulingRuleRequest{}
	mi := &file_weft_proto_msgTypes[408]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateSchedulingRuleRequest) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{408}
}
...
func (x *UpdateSchedulingRuleResponse) Reset() {
	*x = UpdateSchedulingRuleResponse{}
	mi := &file_weft_proto_msgTypes[409]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateSchedulingRuleResponse) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{409}
}
...
func (x *DeleteSchedulingRuleRequest) Reset() {
	*x = DeleteSchedulingRuleRequest{}
	mi := &file_weft_proto_msgTypes[410]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteSchedulingRuleRequest) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{410}
}
...
func (x *DeleteSchedulingRuleResponse) Reset() {
	*x = DeleteSchedulingRuleResponse{}
	mi := &file_weft_proto_msgTypes[411]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteSchedulingRuleResponse) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{411}
}
...
func (x *RegistryRemoteInfo) Reset() {
	*x = RegistryRemoteInfo{}
	mi := &file_weft_proto_msgTypes[412]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegistryRemoteInfo) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{412}
}
...
func (x *ListRegistryRemotesRequest) Reset() {
	*x = ListRegistryRemotesRequest{}
	mi := &file_weft_proto_msgTypes[413]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListRegistryRemotesRequest) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{413}
}
...
func (x *ListRegistryRemotesResponse) Reset() {
	*x = ListRegistryRemotesResponse{}
	mi := &file_weft_proto_msgTypes[414]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListRegistryRemotesResponse) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{414}
}
...
func (x *SetRegistryRemoteRequest) Reset() {
	*x = SetRegistryRemoteRequest{}
	mi := &file_weft_proto_msgTypes[415]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetRegistryRemoteRequest) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{415}
}
...
func (x *SetRegistryRemoteResponse) Reset() {
	*x = SetRegistryRemoteResponse{}
	mi := &file_weft_proto_msgTypes[416]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetRegistryRemoteResponse) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{416}
}
...
func (x *DeleteRegistryRemoteRequest) Reset() {
	*x = DeleteRegistryRemoteRequest{}
	mi := &file_weft_proto_msgTypes[417]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteRegistryRemoteRequest) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{417}
}
...
func (x *DeleteRegistryRemoteResponse) Reset() {
	*x = DeleteRegistryRemoteResponse{}
	mi := &file_weft_proto_msgTypes[418]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteRegistryRemoteResponse) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{418}
}
...
func (x *SearchRegistryRemoteRequest) Reset() {
	*x = SearchRegistryRemoteRequest{}
	mi := &file_weft_proto_msgTypes[419]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchRegistryRemoteRequest) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{419}
}
...
func (x *SearchRegistryRemoteResponse) Reset() {
	*x = SearchRegistryRemoteResponse{}
	mi := &file_weft_proto_msgTypes[420]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchRegistryRemoteResponse) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{420}
}
...
func (x *AttestMsg) Reset() {
	*x = AttestMsg{}
	mi := &file_weft_proto_msgTypes[421]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttestMsg) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{421}
}
...
func (x *AttestResult) Reset() {
	*x = AttestResult{}
	mi := &file_weft_proto_msgTypes[422]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttestResult) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{422}
}
...
func (x *AdmitResult) Reset() {
	*x = AdmitResult{}
	mi := &file_weft_proto_msgTypes[423]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdmitResult) Descriptor() ([]byte, []int) {
	return file_weft_proto_rawDescGZIP(), []int{423}
}
...
const file_weft_proto_rawDesc = "" +
	...
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12,\n" +
	"\x06inputs\x18\x05 \x03(\v2\x14.weft.v1.PluginInputR\x06inputs\"\xe3\x01\n" +
	...
	"\bdisabled\x18\a \x01(\bR\bdisabled\"\x1c\n" +
	...
	"\rinstance_uuid\x18\x01 \x01(\tR\finstanceUuid\"Q\n" +
	"\x16UninstallPluginRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12#\n" +
	"\rinstance_uuid\x18\x02 \x01(\tR\finstanceUuid\"\x19\n" +
	"\x17UninstallPluginResponse\"N\n" +
	"\x13EnablePluginRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12#\n" +
	"\rinstance_uuid\x18\x02 \x01(\tR\finstanceUuid\"\x16\n" +
	"\x14EnablePluginResponse\"O\n" +
	"\x14DisablePluginRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12#\n" +
	"\rinstance_uuid\x18\x02 \x01(\tR\finstanceUuid\"\x17\n" +
	"\x15DisablePluginResponse\"G\n" +
	"\x11SetPodSpecRequest\x12\x15\n" +
	"\x06pod_id\x18\x01 \x01(\tR\x05podId\x12\x1b\n" +
	"\tspec_json\x18\x02 \x01(\fR\bspecJson\"\x14\n" +
	"\x12SetPodSpecResponse\"*\n" +
	"\x11GetPodSpecRequest\x12\x15\n" +
	"\x06pod_id\x18\x01 \x01(\tR\x05podId\"^\n" +
	"\x12GetPodSpecResponse\x12\x15\n" +
	"\x06pod_id\x18\x01 \x01(\tR\x05podId\x12\x1b\n" +
	"\tspec_json\x18\x02 \x01(\fR\bspecJson\x12\x14\n" +
	"\x05found\x18\x03 \x01(\bR\x05found\"a\n" +
	"\x18GetMicroVMMetricsRequest\x12\x17\n" +
	"\avm_uuid\x18\x01 \x01(\tR\x06vmUuid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x18\n" +
	"\aproject\x18\x03 \x01(\tR\aproject\"\xe8\x02\n" +
	"\x16MicroVMMetricsResponse\x12\x17\n" +
	"\avm_uuid\x18\x01 \x01(\tR\x06vmUuid\x12+\n" +
	"\x12sampled_at_unix_ns\x18\x02 \x01(\x03R\x0fsampledAtUnixNs\x12\x1f\n" +
	"\vcpu_percent\x18\x03 \x01(\x01R\n" +
	"cpuPercent\x12 \n" +
	"\fmem_used_mib\x18\x04 \x01(\x04R\n" +
	"memUsedMib\x12\"\n" +
	"\rmem_total_mib\x18\x05 \x01(\x04R\vmemTotalMib\x12\x1c\n" +
	"\n" +
	"net_rx_bps\x18\x06 \x01(\x04R\bnetRxBps\x12\x1c\n" +
	"\n" +
	"net_tx_bps\x18\a \x01(\x04R\bnetTxBps\x12\"\n" +
	"\rdisk_read_bps\x18\b \x01(\x04R\vdiskReadBps\x12$\n" +
	"\x0edisk_write_bps\x18\t \x01(\x04R\fdiskWriteBps\x12\x1b\n" +
	"\tuptime_ms\x18\n" +
	" \x01(\x04R\buptimeMs\"\x17\n" +
	"\x15GetClusterInfoRequest\"\x9c\x01\n" +
	"\x16GetClusterInfoResponse\x12!\n" +
	"\fcluster_name\x18\x01 \x01(\tR\vclusterName\x12&\n" +
	"\x0flocal_host_uuid\x18\x02 \x01(\tR\rlocalHostUuid\x127\n" +
	"\x18control_plane_host_uuids\x18\x03 \x03(\tR\x15controlPlaneHostUuids\":\n" +
	"\x15SetClusterNameRequest\x12!\n" +
	"\fcluster_name\x18\x01 \x01(\tR\vclusterName\";\n" +
	"\x16SetClusterNameResponse\x12!\n" +
	"\fcluster_name\x18\x01 \x01(\tR\vclusterName\"\xb3\b\n" +
	"\bHostInfo\x12\x12\n" +
	...
	"\bcordoned\x18\x0e \x01(\bR\bcordoned\x12#\n" +
	"\ragent_version\x18\x0f \x01(\tR\fagentVersion\x12N\n" +
	"\x0fdriver_versions\x18\x10 \x03(\v2%.weft.v1.HostInfo.DriverVersionsEntryR\x0edriverVersions\x12\x13\n" +
	"\x05os_id\x18\x11 \x01(\tR\x04osId\x12\x1d\n" +
	"\n" +
	"os_version\x18\x12 \x01(\tR\tosVersion\x12\x1b\n" +
	"\tos_pretty\x18\x13 \x01(\tR\bosPretty\x12%\n" +
	"\x0ekernel_version\x18\x14 \x01(\tR\rkernelVersion\x12H\n" +
	"\x12network_interfaces\x18\x15 \x03(\v2\x19.weft.v1.NetworkInterfaceR\x11networkInterfaces\x12<\n" +
	"\x0estorage_mounts\x18\x16 \x03(\v2\x15.weft.v1.StorageMountR\rstorageMounts\x12\x1b\n" +
	"\tcpu_count\x18\x17 \x01(\x05R\bcpuCount\x12\x1d\n" +
	"\n" +
	"memory_mib\x18\x18 \x01(\x03R\tmemoryMib\x12 \n" +
	"\x04gpus\x18\x19 \x03(\v2\f.weft.v1.GPUR\x04gpus\x1a=\n" +
	"\x0fPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\n" +
	"memory_gib\x18\x03 \x01(\x05R\tmemoryGib\x12\x1f\n" +
	"\vmig_capable\x18\x04 \x01(\bR\n" +
	"migCapable\"\xce\x01\n" +
	"\x10NetworkInterface\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03mac\x18\x02 \x01(\tR\x03mac\x12\x1d\n" +
	"\n" +
	"ipv4_cidrs\x18\x03 \x03(\tR\tipv4Cidrs\x12\x1d\n" +
	"\n" +
	"ipv6_cidrs\x18\x04 \x03(\tR\tipv6Cidrs\x12&\n" +
	"\x0flink_speed_mbps\x18\x05 \x01(\x03R\rlinkSpeedMbps\x12\x10\n" +
	"\x03mtu\x18\x06 \x01(\x05R\x03mtu\x12\x1c\n" +
	"\toperstate\x18\a \x01(\tR\toperstate\"\x9e\x01\n" +
	"\fStorageMount\x12\x1e\n" +
	"\n" +
	...
	"totalBytes\x12\x1d\n" +
	"\n" +
	"free_bytes\x18\x05 \x01(\x03R\tfreeBytes\"\xc5\a\n" +
	...
	"properties\x12#\n" +
	"\ragent_version\x18\v \x01(\tR\fagentVersion\x12Y\n" +
	"\x0fdriver_versions\x18\f \x03(\v20.weft.v1.RegisterHostRequest.DriverVersionsEntryR\x0edriverVersions\x12\x13\n" +
	...
	"\x02vm\x18\x01 \x01(\v2\x0f.weft.v1.VMInfoR\x02vm\"@\n" +
	"\x12SetVMStatusRequest\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"6\n" +
	"\x13SetVMStatusResponse\x12\x1f\n" +
	...
	"\x11VM_STATE_DELETING\x10\t2\x82q\n" +
	"\tWeftAgent\x12<\n" +
	...
	"\x0fSetVMProperties\x12\x1f.weft.v1.SetVMPropertiesRequest\x1a .weft.v1.SetVMPropertiesResponse\x12H\n" +
	"\vSetVMStatus\x12\x1b.weft.v1.SetVMStatusRequest\x1a\x1c.weft.v1.SetVMStatusResponse\x12T\n" +
	...
	"\rInstallPlugin\x12\x1d.weft.v1.InstallPluginRequest\x1a\x1e.weft.v1.InstallPluginResponse\x12T\n" +
	"\x0fUninstallPlugin\x12\x1f.weft.v1.UninstallPluginRequest\x1a .weft.v1.UninstallPluginResponse\x12K\n" +
	"\fEnablePlugin\x12\x1c.weft.v1.EnablePluginRequest\x1a\x1d.weft.v1.EnablePluginResponse\x12N\n" +
	"\rDisablePlugin\x12\x1d.weft.v1.DisablePluginRequest\x1a\x1e.weft.v1.DisablePluginResponse\x12H\n" +
	...
	"\x14SearchRegistryRemote\x12$.weft.v1.SearchRegistryRemoteRequest\x1a%.weft.v1.SearchRegistryRemoteResponse\x12E\n" +
	"\n" +
	"SetPodSpec\x12\x1a.weft.v1.SetPodSpecRequest\x1a\x1b.weft.v1.SetPodSpecResponse\x12E\n" +
	"\n" +
	"GetPodSpec\x12\x1a.weft.v1.GetPodSpecRequest\x1a\x1b.weft.v1.GetPodSpecResponse\x12W\n" +
	"\x11GetMicroVMMetrics\x12!.weft.v1.GetMicroVMMetricsRequest\x1a\x1f.weft.v1.MicroVMMetricsResponse\x12Q\n" +
	"\x0eGetClusterInfo\x12\x1e.weft.v1.GetClusterInfoRequest\x1a\x1f.weft.v1.GetClusterInfoResponse\x12Q\n" +
	"\x0eSetClusterName\x12\x1e.weft.v1.SetClusterNameRequest\x1a\x1f.weft.v1.SetClusterNameResponse2N\n" +
	"\rAgentDispatch\x12=\n" +
...
var file_weft_proto_msgTypes = make([]protoimpl.MessageInfo, 435)
var file_weft_proto_goTypes = []any{
	...
	(*UninstallPluginRequest)(nil),                  // 182: weft.v1.UninstallPluginRequest
	(*UninstallPluginResponse)(nil),                 // 183: weft.v1.UninstallPluginResponse
	(*EnablePluginRequest)(nil),                     // 184: weft.v1.EnablePluginRequest
	(*EnablePluginResponse)(nil),                    // 185: weft.v1.EnablePluginResponse
	(*DisablePluginRequest)(nil),                    // 186: weft.v1.DisablePluginRequest
	(*DisablePluginResponse)(nil),                   // 187: weft.v1.DisablePluginResponse
	(*SetPodSpecRequest)(nil),                       // 188: weft.v1.SetPodSpecRequest
	(*SetPodSpecResponse)(nil),                      // 189: weft.v1.SetPodSpecResponse
	(*GetPodSpecRequest)(nil),                       // 190: weft.v1.GetPodSpecRequest
	(*GetPodSpecResponse)(nil),                      // 191: weft.v1.GetPodSpecResponse
	(*GetMicroVMMetricsRequest)(nil),                // 192: weft.v1.GetMicroVMMetricsRequest
	(*MicroVMMetricsResponse)(nil),                  // 193: weft.v1.MicroVMMetricsResponse
	(*GetClusterInfoRequest)(nil),                   // 194: weft.v1.GetClusterInfoRequest
	(*GetClusterInfoResponse)(nil),                  // 195: weft.v1.GetClusterInfoResponse
	(*SetClusterNameRequest)(nil),                   // 196: weft.v1.SetClusterNameRequest
	(*SetClusterNameResponse)(nil),                  // 197: weft.v1.SetClusterNameResponse
	(*HostInfo)(nil),                                // 198: weft.v1.HostInfo
	(*GPU)(nil),                                     // 199: weft.v1.GPU
	(*NetworkInterface)(nil),                        // 200: weft.v1.NetworkInterface
	(*StorageMount)(nil),                            // 201: weft.v1.StorageMount
	(*RegisterHostRequest)(nil),                     // 202: weft.v1.RegisterHostRequest
	(*RegisterHostResponse)(nil),                    // 203: weft.v1.RegisterHostResponse
	(*ListHostsRequest)(nil),                        // 204: weft.v1.ListHostsRequest
	(*ListHostsResponse)(nil),                       // 205: weft.v1.ListHostsResponse
	(*GetHostRequest)(nil),                          // 206: weft.v1.GetHostRequest
	(*GetHostResponse)(nil),                         // 207: weft.v1.GetHostResponse
	(*HeartbeatHostRequest)(nil),                    // 208: weft.v1.HeartbeatHostRequest
	(*HeartbeatHostResponse)(nil),                   // 209: weft.v1.HeartbeatHostResponse
	(*SetHostStateRequest)(nil),                     // 210: weft.v1.SetHostStateRequest
	(*SetHostStateResponse)(nil),                    // 211: weft.v1.SetHostStateResponse
	(*SetHostPropertiesRequest)(nil),                // 212: weft.v1.SetHostPropertiesRequest
	(*SetHostPropertiesResponse)(nil),               // 213: weft.v1.SetHostPropertiesResponse
	(*SetVMPropertiesRequest)(nil),                  // 214: weft.v1.SetVMPropertiesRequest
	(*SetVMPropertiesResponse)(nil),                 // 215: weft.v1.SetVMPropertiesResponse
	(*SetVMStatusRequest)(nil),                      // 216: weft.v1.SetVMStatusRequest
	(*SetVMStatusResponse)(nil),                     // 217: weft.v1.SetVMStatusResponse
	(*GetZombieReportRequest)(nil),                  // 218: weft.v1.GetZombieReportRequest
	(*ZombieEntry)(nil),                             // 219: weft.v1.ZombieEntry
	(*GetZombieReportResponse)(nil),                 // 220: weft.v1.GetZombieReportResponse
	(*TriggerZombieSweepRequest)(nil),               // 221: weft.v1.TriggerZombieSweepRequest
	(*SetHostCordonedRequest)(nil),                  // 222: weft.v1.SetHostCordonedRequest
	(*SetHostCordonedResponse)(nil),                 // 223: weft.v1.SetHostCordonedResponse
	(*DeleteHostRequest)(nil),                       // 224: weft.v1.DeleteHostRequest
	(*DeleteHostResponse)(nil),                      // 225: weft.v1.DeleteHostResponse
	(*AgentMessage)(nil),                            // 226: weft.v1.AgentMessage
	(*ControlMessage)(nil),                          // 227: weft.v1.ControlMessage
	(*AgentHello)(nil),                              // 228: weft.v1.AgentHello
	(*ControlHelloAck)(nil),                         // 229: weft.v1.ControlHelloAck
	(*ControlPing)(nil),                             // 230: weft.v1.ControlPing
	(*AgentPong)(nil),                               // 231: weft.v1.AgentPong
	(*DriverRequest)(nil),                           // 232: weft.v1.DriverRequest
	(*DriverReply)(nil),                             // 233: weft.v1.DriverReply
	(*CreateVMOp)(nil),                              // 234: weft.v1.CreateVMOp
	(*CreateVMResult)(nil),                          // 235: weft.v1.CreateVMResult
	(*RegisterMicroVMOp)(nil),                       // 236: weft.v1.RegisterMicroVMOp
	(*RegisterMicroVMResult)(nil),                   // 237: weft.v1.RegisterMicroVMResult
	(*StartVMOp)(nil),                               // 238: weft.v1.StartVMOp
	(*StartVMResult)(nil),                           // 239: weft.v1.StartVMResult
	(*StopVMOp)(nil),                                // 240: weft.v1.StopVMOp
	(*StopVMResult)(nil),                            // 241: weft.v1.StopVMResult
	(*DeleteVMOp)(nil),                              // 242: weft.v1.DeleteVMOp
	(*DeleteVMResult)(nil),                          // 243: weft.v1.DeleteVMResult
	(*TenantInfo)(nil),                              // 244: weft.v1.TenantInfo
	(*ListTenantsRequest)(nil),                      // 245: weft.v1.ListTenantsRequest
	(*ListTenantsResponse)(nil),                     // 246: weft.v1.ListTenantsResponse
	(*CreateTenantRequest)(nil),                     // 247: weft.v1.CreateTenantRequest
	(*CreateTenantResponse)(nil),                    // 248: weft.v1.CreateTenantResponse
	(*DeleteTenantRequest)(nil),                     // 249: weft.v1.DeleteTenantRequest
	(*DeleteTenantResponse)(nil),                    // 250: weft.v1.DeleteTenantResponse
	(*AddTenantAdminRequest)(nil),                   // 251: weft.v1.AddTenantAdminRequest
	(*AddTenantAdminResponse)(nil),                  // 252: weft.v1.AddTenantAdminResponse
	(*RemoveTenantAdminRequest)(nil),                // 253: weft.v1.RemoveTenantAdminRequest
	(*RemoveTenantAdminResponse)(nil),               // 254: weft.v1.RemoveTenantAdminResponse
	(*AddTenantMemberRequest)(nil),                  // 255: weft.v1.AddTenantMemberRequest
	(*AddTenantMemberResponse)(nil),                 // 256: weft.v1.AddTenantMemberResponse
	(*RemoveTenantMemberRequest)(nil),               // 257: weft.v1.RemoveTenantMemberRequest
	(*RemoveTenantMemberResponse)(nil),              // 258: weft.v1.RemoveTenantMemberResponse
	(*Quotas)(nil),                                  // 259: weft.v1.Quotas
	(*GetTenantQuotaRequest)(nil),                   // 260: weft.v1.GetTenantQuotaRequest
	(*GetTenantQuotaResponse)(nil),                  // 261: weft.v1.GetTenantQuotaResponse
	(*SetTenantQuotaRequest)(nil),                   // 262: weft.v1.SetTenantQuotaRequest
	(*SetTenantQuotaResponse)(nil),                  // 263: weft.v1.SetTenantQuotaResponse
	(*GetProjectQuotaRequest)(nil),                  // 264: weft.v1.GetProjectQuotaRequest
	(*GetProjectQuotaResponse)(nil),                 // 265: weft.v1.GetProjectQuotaResponse
	(*SetProjectQuotaRequest)(nil),                  // 266: weft.v1.SetProjectQuotaRequest
	(*SetProjectQuotaResponse)(nil),                 // 267: weft.v1.SetProjectQuotaResponse
	(*ShareInfo)(nil),                               // 268: weft.v1.ShareInfo
	(*ListSharesRequest)(nil),                       // 269: weft.v1.ListSharesRequest
	(*ListSharesResponse)(nil),                      // 270: weft.v1.ListSharesResponse
	(*CreateShareRequest)(nil),                      // 271: weft.v1.CreateShareRequest
	(*CreateShareResponse)(nil),                     // 272: weft.v1.CreateShareResponse
	(*DeleteShareRequest)(nil),                      // 273: weft.v1.DeleteShareRequest
	(*DeleteShareResponse)(nil),                     // 274: weft.v1.DeleteShareResponse
	(*FloatingIPInfo)(nil),                          // 275: weft.v1.FloatingIPInfo
	(*ListFloatingIPsRequest)(nil),                  // 276: weft.v1.ListFloatingIPsRequest
	(*ListFloatingIPsResponse)(nil),                 // 277: weft.v1.ListFloatingIPsResponse
	(*AllocateFloatingIPRequest)(nil),               // 278: weft.v1.AllocateFloatingIPRequest
	(*AllocateFloatingIPResponse)(nil),              // 279: weft.v1.AllocateFloatingIPResponse
	(*ReleaseFloatingIPRequest)(nil),                // 280: weft.v1.ReleaseFloatingIPRequest
	(*ReleaseFloatingIPResponse)(nil),               // 281: weft.v1.ReleaseFloatingIPResponse
	(*MapFloatingIPRequest)(nil),                    // 282: weft.v1.MapFloatingIPRequest
	(*MapFloatingIPResponse)(nil),                   // 283: weft.v1.MapFloatingIPResponse
	(*UnmapFloatingIPRequest)(nil),                  // 284: weft.v1.UnmapFloatingIPRequest
	(*UnmapFloatingIPResponse)(nil),                 // 285: weft.v1.UnmapFloatingIPResponse
	(*Flavor)(nil),                                  // 286: weft.v1.Flavor
	(*ListFlavorsRequest)(nil),                      // 287: weft.v1.ListFlavorsRequest
	(*ListFlavorsResponse)(nil),                     // 288: weft.v1.ListFlavorsResponse
	(*GetFlavorRequest)(nil),                        // 289: weft.v1.GetFlavorRequest
	(*GetFlavorResponse)(nil),                       // 290: weft.v1.GetFlavorResponse
	(*SetFlavorRequest)(nil),                        // 291: weft.v1.SetFlavorRequest
	(*SetFlavorResponse)(nil),                       // 292: weft.v1.SetFlavorResponse
	(*DeleteFlavorRequest)(nil),                     // 293: weft.v1.DeleteFlavorRequest
	(*DeleteFlavorResponse)(nil),                    // 294: weft.v1.DeleteFlavorResponse
	(*Script)(nil),                                  // 295: weft.v1.Script
	(*ListScriptsRequest)(nil),                      // 296: weft.v1.ListScriptsRequest
	(*ListScriptsResponse)(nil),                     // 297: weft.v1.ListScriptsResponse
	(*GetScriptRequest)(nil),                        // 298: weft.v1.GetScriptRequest
	(*GetScriptResponse)(nil),                       // 299: weft.v1.GetScriptResponse
	(*SetScriptRequest)(nil),                        // 300: weft.v1.SetScriptRequest
	(*SetScriptResponse)(nil),                       // 301: weft.v1.SetScriptResponse
	(*DeleteScriptRequest)(nil),                     // 302: weft.v1.DeleteScriptRequest
	(*DeleteScriptResponse)(nil),                    // 303: weft.v1.DeleteScriptResponse
	(*VMProperty)(nil),                              // 304: weft.v1.VMProperty
	(*ListVMPropertiesRequest)(nil),                 // 305: weft.v1.ListVMPropertiesRequest
	(*ListVMPropertiesResponse)(nil),                // 306: weft.v1.ListVMPropertiesResponse
	(*SetVMPropertyRequest)(nil),                    // 307: weft.v1.SetVMPropertyRequest
	(*SetVMPropertyResponse)(nil),                   // 308: weft.v1.SetVMPropertyResponse
	(*DeleteVMPropertyRequest)(nil),                 // 309: weft.v1.DeleteVMPropertyRequest
	(*DeleteVMPropertyResponse)(nil),                // 310: weft.v1.DeleteVMPropertyResponse
	(*UEFIVar)(nil),                                 // 311: weft.v1.UEFIVar
	(*ListUEFIVarsRequest)(nil),                     // 312: weft.v1.ListUEFIVarsRequest
	(*ListUEFIVarsResponse)(nil),                    // 313: weft.v1.ListUEFIVarsResponse
	(*SetUEFIVarRequest)(nil),                       // 314: weft.v1.SetUEFIVarRequest
	(*SetUEFIVarResponse)(nil),                      // 315: weft.v1.SetUEFIVarResponse
	(*DeleteUEFIVarRequest)(nil),                    // 316: weft.v1.DeleteUEFIVarRequest
	(*DeleteUEFIVarResponse)(nil),                   // 317: weft.v1.DeleteUEFIVarResponse
	(*VMSSHKey)(nil),                                // 318: weft.v1.VMSSHKey
	(*ListVMSSHKeysRequest)(nil),                    // 319: weft.v1.ListVMSSHKeysRequest
	(*ListVMSSHKeysResponse)(nil),                   // 320: weft.v1.ListVMSSHKeysResponse
	(*AddVMSSHKeyRequest)(nil),                      // 321: weft.v1.AddVMSSHKeyRequest
	(*AddVMSSHKeyResponse)(nil),                     // 322: weft.v1.AddVMSSHKeyResponse
	(*RemoveVMSSHKeyRequest)(nil),                   // 323: weft.v1.RemoveVMSSHKeyRequest
	(*RemoveVMSSHKeyResponse)(nil),                  // 324: weft.v1.RemoveVMSSHKeyResponse
	(*SubnetInfo)(nil),                              // 325: weft.v1.SubnetInfo
	(*ListSubnetsRequest)(nil),                      // 326: weft.v1.ListSubnetsRequest
	(*ListSubnetsResponse)(nil),                     // 327: weft.v1.ListSubnetsResponse
	(*GetSubnetRequest)(nil),                        // 328: weft.v1.GetSubnetRequest
	(*GetSubnetResponse)(nil),                       // 329: weft.v1.GetSubnetResponse
	(*CreateSubnetRequest)(nil),                     // 330: weft.v1.CreateSubnetRequest
	(*CreateSubnetResponse)(nil),                    // 331: weft.v1.CreateSubnetResponse
	(*UpdateSubnetRequest)(nil),                     // 332: weft.v1.UpdateSubnetRequest
	(*UpdateSubnetResponse)(nil),                    // 333: weft.v1.UpdateSubnetResponse
	(*DeleteSubnetRequest)(nil),                     // 334: weft.v1.DeleteSubnetRequest
	(*DeleteSubnetResponse)(nil),                    // 335: weft.v1.DeleteSubnetResponse
	(*LBBackend)(nil),                               // 336: weft.v1.LBBackend
	(*LoadBalancerInfo)(nil),                        // 337: weft.v1.LoadBalancerInfo
	(*ListLoadBalancersRequest)(nil),                // 338: weft.v1.ListLoadBalancersRequest
	(*ListLoadBalancersResponse)(nil),               // 339: weft.v1.ListLoadBalancersResponse
	(*GetLoadBalancerRequest)(nil),                  // 340: weft.v1.GetLoadBalancerRequest
	(*GetLoadBalancerResponse)(nil),                 // 341: weft.v1.GetLoadBalancerResponse
	(*CreateLoadBalancerRequest)(nil),               // 342: weft.v1.CreateLoadBalancerRequest
	(*CreateLoadBalancerResponse)(nil),              // 343: weft.v1.CreateLoadBalancerResponse
	(*UpdateLoadBalancerRequest)(nil),               // 344: weft.v1.UpdateLoadBalancerRequest
	(*UpdateLoadBalancerResponse)(nil),              // 345: weft.v1.UpdateLoadBalancerResponse
	(*SetLoadBalancerBackendsRequest)(nil),          // 346: weft.v1.SetLoadBalancerBackendsRequest
	(*SetLoadBalancerBackendsResponse)(nil),         // 347: weft.v1.SetLoadBalancerBackendsResponse
	(*DeleteLoadBalancerRequest)(nil),               // 348: weft.v1.DeleteLoadBalancerRequest
	(*DeleteLoadBalancerResponse)(nil),              // 349: weft.v1.DeleteLoadBalancerResponse
	(*DNSZoneInfo)(nil),                             // 350: weft.v1.DNSZoneInfo
	(*ListDNSZonesRequest)(nil),                     // 351: weft.v1.ListDNSZonesRequest
	(*ListDNSZonesResponse)(nil),                    // 352: weft.v1.ListDNSZonesResponse
	(*GetDNSZoneRequest)(nil),                       // 353: weft.v1.GetDNSZoneRequest
	(*GetDNSZoneResponse)(nil),                      // 354: weft.v1.GetDNSZoneResponse
	(*CreateDNSZoneRequest)(nil),                    // 355: weft.v1.CreateDNSZoneRequest
	(*CreateDNSZoneResponse)(nil),                   // 356: weft.v1.CreateDNSZoneResponse
	(*UpdateDNSZoneRequest)(nil),                    // 357: weft.v1.UpdateDNSZoneRequest
	(*UpdateDNSZoneResponse)(nil),                   // 358: weft.v1.UpdateDNSZoneResponse
	(*DeleteDNSZoneRequest)(nil),                    // 359: weft.v1.DeleteDNSZoneRequest
	(*DeleteDNSZoneResponse)(nil),                   // 360: weft.v1.DeleteDNSZoneResponse
	(*DNSRecordInfo)(nil),                           // 361: weft.v1.DNSRecordInfo
	(*ListDNSRecordsRequest)(nil),                   // 362: weft.v1.ListDNSRecordsRequest
	(*ListDNSRecordsResponse)(nil),                  // 363: weft.v1.ListDNSRecordsResponse
	(*CreateDNSRecordRequest)(nil),                  // 364: weft.v1.CreateDNSRecordRequest
	(*CreateDNSRecordResponse)(nil),                 // 365: weft.v1.CreateDNSRecordResponse
	(*UpdateDNSRecordRequest)(nil),                  // 366: weft.v1.UpdateDNSRecordRequest
	(*UpdateDNSRecordResponse)(nil),                 // 367: weft.v1.UpdateDNSRecordResponse
	(*DeleteDNSRecordRequest)(nil),                  // 368: weft.v1.DeleteDNSRecordRequest
	(*DeleteDNSRecordResponse)(nil),                 // 369: weft.v1.DeleteDNSRecordResponse
	(*VolumePropertyInfo)(nil),                      // 370: weft.v1.VolumePropertyInfo
	(*GetVolumePropertyRequest)(nil),                // 371: weft.v1.GetVolumePropertyRequest
	(*GetVolumePropertyResponse)(nil),               // 372: weft.v1.GetVolumePropertyResponse
	(*SetVolumePropertyRequest)(nil),                // 373: weft.v1.SetVolumePropertyRequest
	(*SetVolumePropertyResponse)(nil),               // 374: weft.v1.SetVolumePropertyResponse
	(*DeleteVolumePropertyRequest)(nil),             // 375: weft.v1.DeleteVolumePropertyRequest
	(*DeleteVolumePropertyResponse)(nil),            // 376: weft.v1.DeleteVolumePropertyResponse
	(*GetShareRequest)(nil),                         // 377: weft.v1.GetShareRequest
	(*GetShareResponse)(nil),                        // 378: weft.v1.GetShareResponse
	(*ResizeShareRequest)(nil),                      // 379: weft.v1.ResizeShareRequest
	(*ResizeShareResponse)(nil),                     // 380: weft.v1.ResizeShareResponse
	(*BucketInfo)(nil),                              // 381: weft.v1.BucketInfo
	(*ListBucketsRequest)(nil),                      // 382: weft.v1.ListBucketsRequest
	(*ListBucketsResponse)(nil),                     // 383: weft.v1.ListBucketsResponse
	(*GetBucketRequest)(nil),                        // 384: weft.v1.GetBucketRequest
	(*GetBucketResponse)(nil),                       // 385: weft.v1.GetBucketResponse
	(*CreateBucketRequest)(nil),                     // 386: weft.v1.CreateBucketRequest
	(*CreateBucketResponse)(nil),                    // 387: weft.v1.CreateBucketResponse
	(*DeleteBucketRequest)(nil),                     // 388: weft.v1.DeleteBucketRequest
	(*DeleteBucketResponse)(nil),                    // 389: weft.v1.DeleteBucketResponse
	(*GetBucketPolicyRequest)(nil),                  // 390: weft.v1.GetBucketPolicyRequest
	(*GetBucketPolicyResponse)(nil),                 // 391: weft.v1.GetBucketPolicyResponse
	(*SetBucketPolicyRequest)(nil),                  // 392: weft.v1.SetBucketPolicyRequest
	(*SetBucketPolicyResponse)(nil),                 // 393: weft.v1.SetBucketPolicyResponse
	(*SSHKeyCatalogueEntry)(nil),                    // 394: weft.v1.SSHKeyCatalogueEntry
	(*ListSSHKeyCatalogueRequest)(nil),              // 395: weft.v1.ListSSHKeyCatalogueRequest
	(*ListSSHKeyCatalogueResponse)(nil),             // 396: weft.v1.ListSSHKeyCatalogueResponse
	(*AddSSHKeyCatalogueRequest)(nil),               // 397: weft.v1.AddSSHKeyCatalogueRequest
	(*AddSSHKeyCatalogueResponse)(nil),              // 398: weft.v1.AddSSHKeyCatalogueResponse
	(*RemoveSSHKeyCatalogueRequest)(nil),            // 399: weft.v1.RemoveSSHKeyCatalogueRequest
	(*RemoveSSHKeyCatalogueResponse)(nil),           // 400: weft.v1.RemoveSSHKeyCatalogueResponse
	(*ImportSSHKeyCatalogueRequest)(nil),            // 401: weft.v1.ImportSSHKeyCatalogueRequest
	(*ImportSSHKeyCatalogueResponse)(nil),           // 402: weft.v1.ImportSSHKeyCatalogueResponse
	(*HealthProbe)(nil),                             // 403: weft.v1.HealthProbe
	(*RespawnPolicy)(nil),                           // 404: weft.v1.RespawnPolicy
	(*SchedulingRuleInfo)(nil),                      // 405: weft.v1.SchedulingRuleInfo
	(*ListSchedulingRulesRequest)(nil),              // 406: weft.v1.ListSchedulingRulesRequest
	(*ListSchedulingRulesResponse)(nil),             // 407: weft.v1.ListSchedulingRulesResponse
	(*CreateSchedulingRuleRequest)(nil),             // 408: weft.v1.CreateSchedulingRuleRequest
	(*CreateSchedulingRuleResponse)(nil),            // 409: weft.v1.CreateSchedulingRuleResponse
	(*UpdateSchedulingRuleRequest)(nil),             // 410: weft.v1.UpdateSchedulingRuleRequest
	(*UpdateSchedulingRuleResponse)(nil),            // 411: weft.v1.UpdateSchedulingRuleResponse
	(*DeleteSchedulingRuleRequest)(nil),             // 412: weft.v1.DeleteSchedulingRuleRequest
	(*DeleteSchedulingRuleResponse)(nil),            // 413: weft.v1.DeleteSchedulingRuleResponse
	(*RegistryRemoteInfo)(nil),                      // 414: weft.v1.RegistryRemoteInfo
	(*ListRegistryRemotesRequest)(nil),              // 415: weft.v1.ListRegistryRemotesRequest
	(*ListRegistryRemotesResponse)(nil),             // 416: weft.v1.ListRegistryRemotesResponse
	(*SetRegistryRemoteRequest)(nil),                // 417: weft.v1.SetRegistryRemoteRequest
	(*SetRegistryRemoteResponse)(nil),               // 418: weft.v1.SetRegistryRemoteResponse
	(*DeleteRegistryRemoteRequest)(nil),             // 419: weft.v1.DeleteRegistryRemoteRequest
	(*DeleteRegistryRemoteResponse)(nil),            // 420: weft.v1.DeleteRegistryRemoteResponse
	(*SearchRegistryRemoteRequest)(nil),             // 421: weft.v1.SearchRegistryRemoteRequest
	(*SearchRegistryRemoteResponse)(nil),            // 422: weft.v1.SearchRegistryRemoteResponse
	(*AttestMsg)(nil),                               // 423: weft.v1.AttestMsg
	(*AttestResult)(nil),                            // 424: weft.v1.AttestResult
	(*AdmitResult)(nil),                             // 425: weft.v1.AdmitResult
	nil,                                             // 426: weft.v1.VMInfo.PropertiesEntry
	nil,                                             // 427: weft.v1.TimingEvent.MetaEntry
	nil,                                             // 428: weft.v1.PlatformEvent.MetaEntry
	nil,                                             // 429: weft.v1.InstallPluginRequest.InputsEntry
	nil,                                             // 430: weft.v1.HostInfo.PropertiesEntry
	nil,                                             // 431: weft.v1.HostInfo.DriverVersionsEntry
	nil,                                             // 432: weft.v1.RegisterHostRequest.PropertiesEntry
	nil,                                             // 433: weft.v1.RegisterHostRequest.DriverVersionsEntry
	nil,                                             // 434: weft.v1.SetHostPropertiesRequest.PropertiesEntry
	nil,                                             // 435: weft.v1.SetVMPropertiesRequest.PropertiesEntry
	nil,                                             // 436: weft.v1.GetZombieReportResponse.ZombiesByKindEntry
}
var file_weft_proto_depIdxs = []int32{
	0,   // 0: weft.v1.VMInfo.state:type_name -> weft.v1.VMState
	426, // 1: weft.v1.VMInfo.properties:type_name -> weft.v1.VMInfo.PropertiesEntry
	...
	427, // 27: weft.v1.TimingEvent.meta:type_name -> weft.v1.TimingEvent.MetaEntry
	...
	428, // 59: weft.v1.PlatformEvent.meta:type_name -> weft.v1.PlatformEvent.MetaEntry
	...
	429, // 69: weft.v1.InstallPluginRequest.inputs:type_name -> weft.v1.InstallPluginRequest.InputsEntry
	430, // 70: weft.v1.HostInfo.properties:type_name -> weft.v1.HostInfo.PropertiesEntry
	431, // 71: weft.v1.HostInfo.driver_versions:type_name -> weft.v1.HostInfo.DriverVersionsEntry
	200, // 72: weft.v1.HostInfo.network_interfaces:type_name -> weft.v1.NetworkInterface
	201, // 73: weft.v1.HostInfo.storage_mounts:type_name -> weft.v1.StorageMount
	199, // 74: weft.v1.HostInfo.gpus:type_name -> weft.v1.GPU
	432, // 75: weft.v1.RegisterHostRequest.properties:type_name -> weft.v1.RegisterHostRequest.PropertiesEntry
	433, // 76: weft.v1.RegisterHostRequest.driver_versions:type_name -> weft.v1.RegisterHostRequest.DriverVersionsEntry
	200, // 77: weft.v1.RegisterHostRequest.network_interfaces:type_name -> weft.v1.NetworkInterface
	201, // 78: weft.v1.RegisterHostRequest.storage_mounts:type_name -> weft.v1.StorageMount
	199, // 79: weft.v1.RegisterHostRequest.gpus:type_name -> weft.v1.GPU
	198, // 80: weft.v1.RegisterHostResponse.host:type_name -> weft.v1.HostInfo
	198, // 81: weft.v1.ListHostsResponse.hosts:type_name -> weft.v1.HostInfo
	198, // 82: weft.v1.GetHostResponse.host:type_name -> weft.v1.HostInfo
	434, // 83: weft.v1.SetHostPropertiesRequest.properties:type_name -> weft.v1.SetHostPropertiesRequest.PropertiesEntry
	435, // 84: weft.v1.SetVMPropertiesRequest.properties:type_name -> weft.v1.SetVMPropertiesRequest.PropertiesEntry
	2,   // 85: weft.v1.SetVMPropertiesResponse.vm:type_name -> weft.v1.VMInfo
	2,   // 86: weft.v1.SetVMStatusResponse.vm:type_name -> weft.v1.VMInfo
	219, // 87: weft.v1.GetZombieReportResponse.zombies:type_name -> weft.v1.ZombieEntry
	436, // 88: weft.v1.GetZombieReportResponse.zombies_by_kind:type_name -> weft.v1.GetZombieReportResponse.ZombiesByKindEntry
	228, // 89: weft.v1.AgentMessage.hello:type_name -> weft.v1.AgentHello
	231, // 90: weft.v1.AgentMessage.pong:type_name -> weft.v1.AgentPong
	233, // 91: weft.v1.AgentMessage.reply:type_name -> weft.v1.DriverReply
	229, // 92: weft.v1.ControlMessage.hello_ack:type_name -> weft.v1.ControlHelloAck
	230, // 93: weft.v1.ControlMessage.ping:type_name -> weft.v1.ControlPing
	232, // 94: weft.v1.ControlMessage.request:type_name -> weft.v1.DriverRequest
	234, // 95: weft.v1.DriverRequest.create_vm:type_name -> weft.v1.CreateVMOp
	236, // 96: weft.v1.DriverRequest.register_micro_vm:type_name -> weft.v1.RegisterMicroVMOp
	238, // 97: weft.v1.DriverRequest.start_vm:type_name -> weft.v1.StartVMOp
	240, // 98: weft.v1.DriverRequest.stop_vm:type_name -> weft.v1.StopVMOp
	242, // 99: weft.v1.DriverRequest.delete_vm:type_name -> weft.v1.DeleteVMOp
	235, // 100: weft.v1.DriverReply.create_vm:type_name -> weft.v1.CreateVMResult
	237, // 101: weft.v1.DriverReply.register_micro_vm:type_name -> weft.v1.RegisterMicroVMResult
	239, // 102: weft.v1.DriverReply.start_vm:type_name -> weft.v1.StartVMResult
	241, // 103: weft.v1.DriverReply.stop_vm:type_name -> weft.v1.StopVMResult
	243, // 104: weft.v1.DriverReply.delete_vm:type_name -> weft.v1.DeleteVMResult
	163, // 105: weft.v1.RegisterMicroVMOp.shares:type_name -> weft.v1.MicroVMShare
	244, // 106: weft.v1.ListTenantsResponse.tenants:type_name -> weft.v1.TenantInfo
	244, // 107: weft.v1.CreateTenantResponse.tenant:type_name -> weft.v1.TenantInfo
	244, // 108: weft.v1.AddTenantAdminResponse.tenant:type_name -> weft.v1.TenantInfo
	244, // 109: weft.v1.RemoveTenantAdminResponse.tenant:type_name -> weft.v1.TenantInfo
	244, // 110: weft.v1.AddTenantMemberResponse.tenant:type_name -> weft.v1.TenantInfo
	244, // 111: weft.v1.RemoveTenantMemberResponse.tenant:type_name -> weft.v1.TenantInfo
	259, // 112: weft.v1.GetTenantQuotaResponse.cap:type_name -> weft.v1.Quotas
	259, // 113: weft.v1.GetTenantQuotaResponse.allocated:type_name -> weft.v1.Quotas
	259, // 114: weft.v1.SetTenantQuotaRequest.cap:type_name -> weft.v1.Quotas
	259, // 115: weft.v1.SetTenantQuotaResponse.cap:type_name -> weft.v1.Quotas
	259, // 116: weft.v1.SetTenantQuotaResponse.allocated:type_name -> weft.v1.Quotas
	259, // 117: weft.v1.GetProjectQuotaResponse.project:type_name -> weft.v1.Quotas
	259, // 118: weft.v1.GetProjectQuotaResponse.tenant_cap:type_name -> weft.v1.Quotas
	259, // 119: weft.v1.GetProjectQuotaResponse.siblings_total:type_name -> weft.v1.Quotas
	259, // 120: weft.v1.SetProjectQuotaRequest.quota:type_name -> weft.v1.Quotas
	259, // 121: weft.v1.SetProjectQuotaResponse.project:type_name -> weft.v1.Quotas
	259, // 122: weft.v1.SetProjectQuotaResponse.tenant_cap:type_name -> weft.v1.Quotas
	259, // 123: weft.v1.SetProjectQuotaResponse.siblings_total:type_name -> weft.v1.Quotas
	268, // 124: weft.v1.ListSharesResponse.shares:type_name -> weft.v1.ShareInfo
	268, // 125: weft.v1.CreateShareResponse.share:type_name -> weft.v1.ShareInfo
	275, // 126: weft.v1.ListFloatingIPsResponse.floating_ips:type_name -> weft.v1.FloatingIPInfo
	275, // 127: weft.v1.AllocateFloatingIPResponse.floating_ip:type_name -> weft.v1.FloatingIPInfo
	275, // 128: weft.v1.MapFloatingIPResponse.floating_ip:type_name -> weft.v1.FloatingIPInfo
	275, // 129: weft.v1.UnmapFloatingIPResponse.floating_ip:type_name -> weft.v1.FloatingIPInfo
	286, // 130: weft.v1.ListFlavorsResponse.flavors:type_name -> weft.v1.Flavor
	286, // 131: weft.v1.GetFlavorResponse.flavor:type_name -> weft.v1.Flavor
	286, // 132: weft.v1.SetFlavorRequest.flavor:type_name -> weft.v1.Flavor
	286, // 133: weft.v1.SetFlavorResponse.flavor:type_name -> weft.v1.Flavor
	295, // 134: weft.v1.ListScriptsResponse.scripts:type_name -> weft.v1.Script
	295, // 135: weft.v1.GetScriptResponse.script:type_name -> weft.v1.Script
	295, // 136: weft.v1.SetScriptRequest.script:type_name -> weft.v1.Script
	295, // 137: weft.v1.SetScriptResponse.script:type_name -> weft.v1.Script
	304, // 138: weft.v1.ListVMPropertiesResponse.properties:type_name -> weft.v1.VMProperty
	304, // 139: weft.v1.SetVMPropertyRequest.property:type_name -> weft.v1.VMProperty
	304, // 140: weft.v1.SetVMPropertyResponse.property:type_name -> weft.v1.VMProperty
	311, // 141: weft.v1.ListUEFIVarsResponse.vars:type_name -> weft.v1.UEFIVar
	311, // 142: weft.v1.SetUEFIVarRequest.var:type_name -> weft.v1.UEFIVar
	311, // 143: weft.v1.SetUEFIVarResponse.var:type_name -> weft.v1.UEFIVar
	318, // 144: weft.v1.ListVMSSHKeysResponse.keys:type_name -> weft.v1.VMSSHKey
	318, // 145: weft.v1.AddVMSSHKeyResponse.key:type_name -> weft.v1.VMSSHKey
	325, // 146: weft.v1.ListSubnetsResponse.subnets:type_name -> weft.v1.SubnetInfo
	325, // 147: weft.v1.GetSubnetResponse.subnet:type_name -> weft.v1.SubnetInfo
	325, // 148: weft.v1.CreateSubnetResponse.subnet:type_name -> weft.v1.SubnetInfo
	325, // 149: weft.v1.UpdateSubnetResponse.subnet:type_name -> weft.v1.SubnetInfo
	336, // 150: weft.v1.LoadBalancerInfo.backends:type_name -> weft.v1.LBBackend
	337, // 151: weft.v1.ListLoadBalancersResponse.load_balancers:type_name -> weft.v1.LoadBalancerInfo
	337, // 152: weft.v1.GetLoadBalancerResponse.load_balancer:type_name -> weft.v1.LoadBalancerInfo
	336, // 153: weft.v1.CreateLoadBalancerRequest.backends:type_name -> weft.v1.LBBackend
	337, // 154: weft.v1.CreateLoadBalancerResponse.load_balancer:type_name -> weft.v1.LoadBalancerInfo
	337, // 155: weft.v1.UpdateLoadBalancerResponse.load_balancer:type_name -> weft.v1.LoadBalancerInfo
	336, // 156: weft.v1.SetLoadBalancerBackendsRequest.backends:type_name -> weft.v1.LBBackend
	337, // 157: weft.v1.SetLoadBalancerBackendsResponse.load_balancer:type_name -> weft.v1.LoadBalancerInfo
	350, // 158: weft.v1.ListDNSZonesResponse.zones:type_name -> weft.v1.DNSZoneInfo
	350, // 159: weft.v1.GetDNSZoneResponse.zone:type_name -> weft.v1.DNSZoneInfo
	350, // 160: weft.v1.CreateDNSZoneResponse.zone:type_name -> weft.v1.DNSZoneInfo
	350, // 161: weft.v1.UpdateDNSZoneResponse.zone:type_name -> weft.v1.DNSZoneInfo
	361, // 162: weft.v1.ListDNSRecordsResponse.records:type_name -> weft.v1.DNSRecordInfo
	361, // 163: weft.v1.CreateDNSRecordResponse.record:type_name -> weft.v1.DNSRecordInfo
	361, // 164: weft.v1.UpdateDNSRecordResponse.record:type_name -> weft.v1.DNSRecordInfo
	370, // 165: weft.v1.GetVolumePropertyResponse.property:type_name -> weft.v1.VolumePropertyInfo
	370, // 166: weft.v1.SetVolumePropertyResponse.property:type_name -> weft.v1.VolumePropertyInfo
	268, // 167: weft.v1.GetShareResponse.share:type_name -> weft.v1.ShareInfo
	268, // 168: weft.v1.ResizeShareResponse.share:type_name -> weft.v1.ShareInfo
	381, // 169: weft.v1.ListBucketsResponse.buckets:type_name -> weft.v1.BucketInfo
	381, // 170: weft.v1.GetBucketResponse.bucket:type_name -> weft.v1.BucketInfo
	381, // 171: weft.v1.CreateBucketResponse.bucket:type_name -> weft.v1.BucketInfo
	381, // 172: weft.v1.SetBucketPolicyResponse.bucket:type_name -> weft.v1.BucketInfo
	394, // 173: weft.v1.ListSSHKeyCatalogueResponse.keys:type_name -> weft.v1.SSHKeyCatalogueEntry
	394, // 174: weft.v1.AddSSHKeyCatalogueResponse.key:type_name -> weft.v1.SSHKeyCatalogueEntry
	394, // 175: weft.v1.ImportSSHKeyCatalogueResponse.imported:type_name -> weft.v1.SSHKeyCatalogueEntry
	1,   // 176: weft.v1.HealthProbe.type:type_name -> weft.v1.HealthProbe.Type
	403, // 177: weft.v1.RespawnPolicy.liveness:type_name -> weft.v1.HealthProbe
	403, // 178: weft.v1.RespawnPolicy.readiness:type_name -> weft.v1.HealthProbe
	404, // 179: weft.v1.SchedulingRuleInfo.respawn:type_name -> weft.v1.RespawnPolicy
	405, // 180: weft.v1.ListSchedulingRulesResponse.rules:type_name -> weft.v1.SchedulingRuleInfo
	404, // 181: weft.v1.CreateSchedulingRuleRequest.respawn:type_name -> weft.v1.RespawnPolicy
	405, // 182: weft.v1.CreateSchedulingRuleResponse.rule:type_name -> weft.v1.SchedulingRuleInfo
	404, // 183: weft.v1.UpdateSchedulingRuleRequest.respawn:type_name -> weft.v1.RespawnPolicy
	405, // 184: weft.v1.UpdateSchedulingRuleResponse.rule:type_name -> weft.v1.SchedulingRuleInfo
	414, // 185: weft.v1.ListRegistryRemotesResponse.remotes:type_name -> weft.v1.RegistryRemoteInfo
	414, // 186: weft.v1.SetRegistryRemoteResponse.remote:type_name -> weft.v1.RegistryRemoteInfo
	36,  // 187: weft.v1.WeftAgent.ListVMs:input_type -> weft.v1.ListVMsRequest
	44,  // 188: weft.v1.WeftAgent.VMStatus:input_type -> weft.v1.VMStatusRequest
	38,  // 189: weft.v1.WeftAgent.StartVM:input_type -> weft.v1.StartVMRequest
	40,  // 190: weft.v1.WeftAgent.StopVM:input_type -> weft.v1.StopVMRequest
	42,  // 191: weft.v1.WeftAgent.RestartVM:input_type -> weft.v1.RestartVMRequest
	48,  // 192: weft.v1.WeftAgent.CreateVM:input_type -> weft.v1.CreateVMRequest
	50,  // 193: weft.v1.WeftAgent.DeleteVM:input_type -> weft.v1.DeleteVMRequest
	55,  // 194: weft.v1.WeftAgent.ProvisionVM:input_type -> weft.v1.ProvisionVMRequest
	57,  // 195: weft.v1.WeftAgent.DeprovisionVM:input_type -> weft.v1.DeprovisionVMRequest
	59,  // 196: weft.v1.WeftAgent.PullImages:input_type -> weft.v1.PullImagesRequest
	61,  // 197: weft.v1.WeftAgent.PullImage:input_type -> weft.v1.PullImageRequest
	63,  // 198: weft.v1.WeftAgent.PatchImage:input_type -> weft.v1.PatchImageRequest
	65,  // 199: weft.v1.WeftAgent.ListImages:input_type -> weft.v1.ListImagesRequest
	68,  // 200: weft.v1.WeftAgent.CleanImages:input_type -> weft.v1.CleanImagesRequest
	70,  // 201: weft.v1.WeftAgent.WaitVM:input_type -> weft.v1.WaitVMRequest
	164, // 202: weft.v1.WeftAgent.RegisterMicroVM:input_type -> weft.v1.RegisterMicroVMRequest
	73,  // 203: weft.v1.WeftAgent.VMTimings:input_type -> weft.v1.VMTimingsRequest
	75,  // 204: weft.v1.WeftAgent.VMLogs:input_type -> weft.v1.VMLogsRequest
	4,   // 205: weft.v1.WeftAgent.ListAZs:input_type -> weft.v1.ListAZsRequest
	6,   // 206: weft.v1.WeftAgent.GetAZ:input_type -> weft.v1.GetAZRequest
	8,   // 207: weft.v1.WeftAgent.CreateAZ:input_type -> weft.v1.CreateAZRequest
	10,  // 208: weft.v1.WeftAgent.UpdateAZ:input_type -> weft.v1.UpdateAZRequest
	12,  // 209: weft.v1.WeftAgent.DeleteAZ:input_type -> weft.v1.DeleteAZRequest
	15,  // 210: weft.v1.WeftAgent.ListRacks:input_type -> weft.v1.ListRacksRequest
	17,  // 211: weft.v1.WeftAgent.GetRack:input_type -> weft.v1.GetRackRequest
	19,  // 212: weft.v1.WeftAgent.CreateRack:input_type -> weft.v1.CreateRackRequest
	21,  // 213: weft.v1.WeftAgent.UpdateRack:input_type -> weft.v1.UpdateRackRequest
	23,  // 214: weft.v1.WeftAgent.DeleteRack:input_type -> weft.v1.DeleteRackRequest
	26,  // 215: weft.v1.WeftAgent.ListProjects:input_type -> weft.v1.ListProjectsRequest
	28,  // 216: weft.v1.WeftAgent.CreateProject:input_type -> weft.v1.CreateProjectRequest
	30,  // 217: weft.v1.WeftAgent.RenameProject:input_type -> weft.v1.RenameProjectRequest
	32,  // 218: weft.v1.WeftAgent.DeleteProject:input_type -> weft.v1.DeleteProjectRequest
	34,  // 219: weft.v1.WeftAgent.SetProjectTenant:input_type -> weft.v1.SetProjectTenantRequest
	77,  // 220: weft.v1.WeftAgent.AddProjectMember:input_type -> weft.v1.AddProjectMemberRequest
	79,  // 221: weft.v1.WeftAgent.RemoveProjectMember:input_type -> weft.v1.RemoveProjectMemberRequest
	81,  // 222: weft.v1.WeftAgent.ListProjectMembers:input_type -> weft.v1.ListProjectMembersRequest
	84,  // 223: weft.v1.WeftAgent.ListUsers:input_type -> weft.v1.ListUsersRequest
	86,  // 224: weft.v1.WeftAgent.GetUser:input_type -> weft.v1.GetUserRequest
	88,  // 225: weft.v1.WeftAgent.Me:input_type -> weft.v1.MeRequest
	90,  // 226: weft.v1.WeftAgent.SetUserDisplayName:input_type -> weft.v1.SetUserDisplayNameRequest
	92,  // 227: weft.v1.WeftAgent.DeleteUser:input_type -> weft.v1.DeleteUserRequest
	95,  // 228: weft.v1.WeftAgent.ListNetworks:input_type -> weft.v1.ListNetworksRequest
	97,  // 229: weft.v1.WeftAgent.CreateNetwork:input_type -> weft.v1.CreateNetworkRequest
	99,  // 230: weft.v1.WeftAgent.RenameNetwork:input_type -> weft.v1.RenameNetworkRequest
	101, // 231: weft.v1.WeftAgent.SetNetworkDNS:input_type -> weft.v1.SetNetworkDNSRequest
	103, // 232: weft.v1.WeftAgent.DeleteNetwork:input_type -> weft.v1.DeleteNetworkRequest
	105, // 233: weft.v1.WeftAgent.SetNetworkDefaultSecurityGroups:input_type -> weft.v1.SetNetworkDefaultSecurityGroupsRequest
	108, // 234: weft.v1.WeftAgent.ListPortsForVM:input_type -> weft.v1.ListPortsForVMRequest
	112, // 235: weft.v1.WeftAgent.ListSecurityGroups:input_type -> weft.v1.ListSecurityGroupsRequest
	114, // 236: weft.v1.WeftAgent.CreateSecurityGroup:input_type -> weft.v1.CreateSecurityGroupRequest
	116, // 237: weft.v1.WeftAgent.RenameSecurityGroup:input_type -> weft.v1.RenameSecurityGroupRequest
	118, // 238: weft.v1.WeftAgent.SetSecurityGroupDescription:input_type -> weft.v1.SetSecurityGroupDescriptionRequest
	120, // 239: weft.v1.WeftAgent.SetSecurityGroupRules:input_type -> weft.v1.SetSecurityGroupRulesRequest
	122, // 240: weft.v1.WeftAgent.DeleteSecurityGroup:input_type -> weft.v1.DeleteSecurityGroupRequest
	125, // 241: weft.v1.WeftAgent.ListVolumes:input_type -> weft.v1.ListVolumesRequest
	127, // 242: weft.v1.WeftAgent.CreateVolume:input_type -> weft.v1.CreateVolumeRequest
	129, // 243: weft.v1.WeftAgent.RenameVolume:input_type -> weft.v1.RenameVolumeRequest
	131, // 244: weft.v1.WeftAgent.ResizeVolume:input_type -> weft.v1.ResizeVolumeRequest
	133, // 245: weft.v1.WeftAgent.AttachVolume:input_type -> weft.v1.AttachVolumeRequest
	135, // 246: weft.v1.WeftAgent.DetachVolume:input_type -> weft.v1.DetachVolumeRequest
	137, // 247: weft.v1.WeftAgent.DeleteVolume:input_type -> weft.v1.DeleteVolumeRequest
	140, // 248: weft.v1.WeftAgent.CreateVolumeSnapshot:input_type -> weft.v1.CreateVolumeSnapshotRequest
	142, // 249: weft.v1.WeftAgent.ListVolumeSnapshots:input_type -> weft.v1.ListVolumeSnapshotsRequest
	144, // 250: weft.v1.WeftAgent.RestoreVolumeSnapshot:input_type -> weft.v1.RestoreVolumeSnapshotRequest
	148, // 251: weft.v1.WeftAgent.RevertVolumeSnapshot:input_type -> weft.v1.RevertVolumeSnapshotRequest
	146, // 252: weft.v1.WeftAgent.DeleteVolumeSnapshot:input_type -> weft.v1.DeleteVolumeSnapshotRequest
	151, // 253: weft.v1.WeftAgent.CreateVolumeBackup:input_type -> weft.v1.CreateVolumeBackupRequest
	153, // 254: weft.v1.WeftAgent.ListVolumeBackups:input_type -> weft.v1.ListVolumeBackupsRequest
	155, // 255: weft.v1.WeftAgent.DeleteVolumeBackup:input_type -> weft.v1.DeleteVolumeBackupRequest
	157, // 256: weft.v1.WeftAgent.RestoreVolumeBackup:input_type -> weft.v1.RestoreVolumeBackupRequest
	160, // 257: weft.v1.WeftAgent.WatchEvents:input_type -> weft.v1.WatchEventsRequest
	161, // 258: weft.v1.WeftAgent.RenderNATSAuthorization:input_type -> weft.v1.RenderNATSAuthorizationRequest
	202, // 259: weft.v1.WeftAgent.RegisterHost:input_type -> weft.v1.RegisterHostRequest
	204, // 260: weft.v1.WeftAgent.ListHosts:input_type -> weft.v1.ListHostsRequest
	206, // 261: weft.v1.WeftAgent.GetHost:input_type -> weft.v1.GetHostRequest
	208, // 262: weft.v1.WeftAgent.HeartbeatHost:input_type -> weft.v1.HeartbeatHostRequest
	210, // 263: weft.v1.WeftAgent.SetHostState:input_type -> weft.v1.SetHostStateRequest
	212, // 264: weft.v1.WeftAgent.SetHostProperties:input_type -> weft.v1.SetHostPropertiesRequest
	214, // 265: weft.v1.WeftAgent.SetVMProperties:input_type -> weft.v1.SetVMPropertiesRequest
	216, // 266: weft.v1.WeftAgent.SetVMStatus:input_type -> weft.v1.SetVMStatusRequest
	218, // 267: weft.v1.WeftAgent.GetZombieReport:input_type -> weft.v1.GetZombieReportRequest
	221, // 268: weft.v1.WeftAgent.TriggerZombieSweep:input_type -> weft.v1.TriggerZombieSweepRequest
	222, // 269: weft.v1.WeftAgent.SetHostCordoned:input_type -> weft.v1.SetHostCordonedRequest
	224, // 270: weft.v1.WeftAgent.DeleteHost:input_type -> weft.v1.DeleteHostRequest
	168, // 271: weft.v1.WeftAgent.PublishShareToProject:input_type -> weft.v1.PublishShareToProjectRequest
	245, // 272: weft.v1.WeftAgent.ListTenants:input_type -> weft.v1.ListTenantsRequest
	247, // 273: weft.v1.WeftAgent.CreateTenant:input_type -> weft.v1.CreateTenantRequest
	249, // 274: weft.v1.WeftAgent.DeleteTenant:input_type -> weft.v1.DeleteTenantRequest
	251, // 275: weft.v1.WeftAgent.AddTenantAdmin:input_type -> weft.v1.AddTenantAdminRequest
	253, // 276: weft.v1.WeftAgent.RemoveTenantAdmin:input_type -> weft.v1.RemoveTenantAdminRequest
	255, // 277: weft.v1.WeftAgent.AddTenantMember:input_type -> weft.v1.AddTenantMemberRequest
	257, // 278: weft.v1.WeftAgent.RemoveTenantMember:input_type -> weft.v1.RemoveTenantMemberRequest
	260, // 279: weft.v1.WeftAgent.GetTenantQuota:input_type -> weft.v1.GetTenantQuotaRequest
	262, // 280: weft.v1.WeftAgent.SetTenantQuota:input_type -> weft.v1.SetTenantQuotaRequest
	264, // 281: weft.v1.WeftAgent.GetProjectQuota:input_type -> weft.v1.GetProjectQuotaRequest
	266, // 282: weft.v1.WeftAgent.SetProjectQuota:input_type -> weft.v1.SetProjectQuotaRequest
	269, // 283: weft.v1.WeftAgent.ListShares:input_type -> weft.v1.ListSharesRequest
	271, // 284: weft.v1.WeftAgent.CreateShare:input_type -> weft.v1.CreateShareRequest
	273, // 285: weft.v1.WeftAgent.DeleteShare:input_type -> weft.v1.DeleteShareRequest
	276, // 286: weft.v1.WeftAgent.ListFloatingIPs:input_type -> weft.v1.ListFloatingIPsRequest
	278, // 287: weft.v1.WeftAgent.AllocateFloatingIP:input_type -> weft.v1.AllocateFloatingIPRequest
	280, // 288: weft.v1.WeftAgent.ReleaseFloatingIP:input_type -> weft.v1.ReleaseFloatingIPRequest
	282, // 289: weft.v1.WeftAgent.MapFloatingIP:input_type -> weft.v1.MapFloatingIPRequest
	284, // 290: weft.v1.WeftAgent.UnmapFloatingIP:input_type -> weft.v1.UnmapFloatingIPRequest
	287, // 291: weft.v1.WeftAgent.ListFlavors:input_type -> weft.v1.ListFlavorsRequest
	289, // 292: weft.v1.WeftAgent.GetFlavor:input_type -> weft.v1.GetFlavorRequest
	291, // 293: weft.v1.WeftAgent.SetFlavor:input_type -> weft.v1.SetFlavorRequest
	293, // 294: weft.v1.WeftAgent.DeleteFlavor:input_type -> weft.v1.DeleteFlavorRequest
	296, // 295: weft.v1.WeftAgent.ListScripts:input_type -> weft.v1.ListScriptsRequest
	298, // 296: weft.v1.WeftAgent.GetScript:input_type -> weft.v1.GetScriptRequest
	300, // 297: weft.v1.WeftAgent.SetScript:input_type -> weft.v1.SetScriptRequest
	302, // 298: weft.v1.WeftAgent.DeleteScript:input_type -> weft.v1.DeleteScriptRequest
	305, // 299: weft.v1.WeftAgent.ListVMProperties:input_type -> weft.v1.ListVMPropertiesRequest
	307, // 300: weft.v1.WeftAgent.SetVMProperty:input_type -> weft.v1.SetVMPropertyRequest
	309, // 301: weft.v1.WeftAgent.DeleteVMProperty:input_type -> weft.v1.DeleteVMPropertyRequest
	312, // 302: weft.v1.WeftAgent.ListUEFIVars:input_type -> weft.v1.ListUEFIVarsRequest
	314, // 303: weft.v1.WeftAgent.SetUEFIVar:input_type -> weft.v1.SetUEFIVarRequest
	316, // 304: weft.v1.WeftAgent.DeleteUEFIVar:input_type -> weft.v1.DeleteUEFIVarRequest
	319, // 305: weft.v1.WeftAgent.ListVMSSHKeys:input_type -> weft.v1.ListVMSSHKeysRequest
	321, // 306: weft.v1.WeftAgent.AddVMSSHKey:input_type -> weft.v1.AddVMSSHKeyRequest
	323, // 307: weft.v1.WeftAgent.RemoveVMSSHKey:input_type -> weft.v1.RemoveVMSSHKeyRequest
	171, // 308: weft.v1.WeftAgent.ListFederationPeers:input_type -> weft.v1.ListFederationPeersRequest
	176, // 309: weft.v1.WeftAgent.ListPluginCatalogue:input_type -> weft.v1.ListPluginCatalogueRequest
	178, // 310: weft.v1.WeftAgent.ListInstalledPlugins:input_type -> weft.v1.ListInstalledPluginsRequest
	180, // 311: weft.v1.WeftAgent.InstallPlugin:input_type -> weft.v1.InstallPluginRequest
	182, // 312: weft.v1.WeftAgent.UninstallPlugin:input_type -> weft.v1.UninstallPluginRequest
	184, // 313: weft.v1.WeftAgent.EnablePlugin:input_type -> weft.v1.EnablePluginRequest
	186, // 314: weft.v1.WeftAgent.DisablePlugin:input_type -> weft.v1.DisablePluginRequest
	326, // 315: weft.v1.WeftAgent.ListSubnets:input_type -> weft.v1.ListSubnetsRequest
	328, // 316: weft.v1.WeftAgent.GetSubnet:input_type -> weft.v1.GetSubnetRequest
	330, // 317: weft.v1.WeftAgent.CreateSubnet:input_type -> weft.v1.CreateSubnetRequest
	332, // 318: weft.v1.WeftAgent.UpdateSubnet:input_type -> weft.v1.UpdateSubnetRequest
	334, // 319: weft.v1.WeftAgent.DeleteSubnet:input_type -> weft.v1.DeleteSubnetRequest
	338, // 320: weft.v1.WeftAgent.ListLoadBalancers:input_type -> weft.v1.ListLoadBalancersRequest
	340, // 321: weft.v1.WeftAgent.GetLoadBalancer:input_type -> weft.v1.GetLoadBalancerRequest
	342, // 322: weft.v1.WeftAgent.CreateLoadBalancer:input_type -> weft.v1.CreateLoadBalancerRequest
	344, // 323: weft.v1.WeftAgent.UpdateLoadBalancer:input_type -> weft.v1.UpdateLoadBalancerRequest
	346, // 324: weft.v1.WeftAgent.SetLoadBalancerBackends:input_type -> weft.v1.SetLoadBalancerBackendsRequest
	348, // 325: weft.v1.WeftAgent.DeleteLoadBalancer:input_type -> weft.v1.DeleteLoadBalancerRequest
	351, // 326: weft.v1.WeftAgent.ListDNSZones:input_type -> weft.v1.ListDNSZonesRequest
	353, // 327: weft.v1.WeftAgent.GetDNSZone:input_type -> weft.v1.GetDNSZoneRequest
	355, // 328: weft.v1.WeftAgent.CreateDNSZone:input_type -> weft.v1.CreateDNSZoneRequest
	357, // 329: weft.v1.WeftAgent.UpdateDNSZone:input_type -> weft.v1.UpdateDNSZoneRequest
	359, // 330: weft.v1.WeftAgent.DeleteDNSZone:input_type -> weft.v1.DeleteDNSZoneRequest
	362, // 331: weft.v1.WeftAgent.ListDNSRecords:input_type -> weft.v1.ListDNSRecordsRequest
	364, // 332: weft.v1.WeftAgent.CreateDNSRecord:input_type -> weft.v1.CreateDNSRecordRequest
	366, // 333: weft.v1.WeftAgent.UpdateDNSRecord:input_type -> weft.v1.UpdateDNSRecordRequest
	368, // 334: weft.v1.WeftAgent.DeleteDNSRecord:input_type -> weft.v1.DeleteDNSRecordRequest
	371, // 335: weft.v1.WeftAgent.GetVolumeProperty:input_type -> weft.v1.GetVolumePropertyRequest
	373, // 336: weft.v1.WeftAgent.SetVolumeProperty:input_type -> weft.v1.SetVolumePropertyRequest
	375, // 337: weft.v1.WeftAgent.DeleteVolumeProperty:input_type -> weft.v1.DeleteVolumePropertyRequest
	377, // 338: weft.v1.WeftAgent.GetShare:input_type -> weft.v1.GetShareRequest
	379, // 339: weft.v1.WeftAgent.ResizeShare:input_type -> weft.v1.ResizeShareRequest
	382, // 340: weft.v1.WeftAgent.ListBuckets:input_type -> weft.v1.ListBucketsRequest
	384, // 341: weft.v1.WeftAgent.GetBucket:input_type -> weft.v1.GetBucketRequest
	386, // 342: weft.v1.WeftAgent.CreateBucket:input_type -> weft.v1.CreateBucketRequest
	388, // 343: weft.v1.WeftAgent.DeleteBucket:input_type -> weft.v1.DeleteBucketRequest
	390, // 344: weft.v1.WeftAgent.GetBucketPolicy:input_type -> weft.v1.GetBucketPolicyRequest
	392, // 345: weft.v1.WeftAgent.SetBucketPolicy:input_type -> weft.v1.SetBucketPolicyRequest
	395, // 346: weft.v1.WeftAgent.ListSSHKeyCatalogue:input_type -> weft.v1.ListSSHKeyCatalogueRequest
	397, // 347: weft.v1.WeftAgent.AddSSHKeyCatalogue:input_type -> weft.v1.AddSSHKeyCatalogueRequest
	399, // 348: weft.v1.WeftAgent.RemoveSSHKeyCatalogue:input_type -> weft.v1.RemoveSSHKeyCatalogueRequest
	401, // 349: weft.v1.WeftAgent.ImportSSHKeyCatalogue:input_type -> weft.v1.ImportSSHKeyCatalogueRequest
	406, // 350: weft.v1.WeftAgent.ListSchedulingRules:input_type -> weft.v1.ListSchedulingRulesRequest
	408, // 351: weft.v1.WeftAgent.CreateSchedulingRule:input_type -> weft.v1.CreateSchedulingRuleRequest
	410, // 352: weft.v1.WeftAgent.UpdateSchedulingRule:input_type -> weft.v1.UpdateSchedulingRuleRequest
	412, // 353: weft.v1.WeftAgent.DeleteSchedulingRule:input_type -> weft.v1.DeleteSchedulingRuleRequest
	415, // 354: weft.v1.WeftAgent.ListRegistryRemotes:input_type -> weft.v1.ListRegistryRemotesRequest
	417, // 355: weft.v1.WeftAgent.SetRegistryRemote:input_type -> weft.v1.SetRegistryRemoteRequest
	419, // 356: weft.v1.WeftAgent.DeleteRegistryRemote:input_type -> weft.v1.DeleteRegistryRemoteRequest
	421, // 357: weft.v1.WeftAgent.SearchRegistryRemote:input_type -> weft.v1.SearchRegistryRemoteRequest
	188, // 358: weft.v1.WeftAgent.SetPodSpec:input_type -> weft.v1.SetPodSpecRequest
	190, // 359: weft.v1.WeftAgent.GetPodSpec:input_type -> weft.v1.GetPodSpecRequest
	192, // 360: weft.v1.WeftAgent.GetMicroVMMetrics:input_type -> weft.v1.GetMicroVMMetricsRequest
	194, // 361: weft.v1.WeftAgent.GetClusterInfo:input_type -> weft.v1.GetClusterInfoRequest
	196, // 362: weft.v1.WeftAgent.SetClusterName:input_type -> weft.v1.SetClusterNameRequest
	226, // 363: weft.v1.AgentDispatch.Connect:input_type -> weft.v1.AgentMessage
	423, // 364: weft.v1.AttestationService.Enroll:input_type -> weft.v1.AttestMsg
	423, // 365: weft.v1.AttestationService.CompleteEnroll:input_type -> weft.v1.AttestMsg
	423, // 366: weft.v1.AttestationService.RequestAdmission:input_type -> weft.v1.AttestMsg
	423, // 367: weft.v1.AttestationService.Admit:input_type -> weft.v1.AttestMsg
	37,  // 368: weft.v1.WeftAgent.ListVMs:output_type -> weft.v1.ListVMsResponse
	45,  // 369: weft.v1.WeftAgent.VMStatus:output_type -> weft.v1.VMStatusResponse
	39,  // 370: weft.v1.WeftAgent.StartVM:output_type -> weft.v1.StartVMResponse
	41,  // 371: weft.v1.WeftAgent.StopVM:output_type -> weft.v1.StopVMResponse
	43,  // 372: weft.v1.WeftAgent.RestartVM:output_type -> weft.v1.RestartVMResponse
	49,  // 373: weft.v1.WeftAgent.CreateVM:output_type -> weft.v1.CreateVMResponse
	51,  // 374: weft.v1.WeftAgent.DeleteVM:output_type -> weft.v1.DeleteVMResponse
	56,  // 375: weft.v1.WeftAgent.ProvisionVM:output_type -> weft.v1.ProvisionVMResponse
	58,  // 376: weft.v1.WeftAgent.DeprovisionVM:output_type -> weft.v1.DeprovisionVMResponse
	60,  // 377: weft.v1.WeftAgent.PullImages:output_type -> weft.v1.PullImagesResponse
	62,  // 378: weft.v1.WeftAgent.PullImage:output_type -> weft.v1.PullImageResponse
	64,  // 379: weft.v1.WeftAgent.PatchImage:output_type -> weft.v1.PatchImageResponse
	67,  // 380: weft.v1.WeftAgent.ListImages:output_type -> weft.v1.ListImagesResponse
	69,  // 381: weft.v1.WeftAgent.CleanImages:output_type -> weft.v1.CleanImagesResponse
	71,  // 382: weft.v1.WeftAgent.WaitVM:output_type -> weft.v1.WaitVMResponse
	165, // 383: weft.v1.WeftAgent.RegisterMicroVM:output_type -> weft.v1.RegisterMicroVMResponse
	74,  // 384: weft.v1.WeftAgent.VMTimings:output_type -> weft.v1.VMTimingsResponse
	76,  // 385: weft.v1.WeftAgent.VMLogs:output_type -> weft.v1.VMLogsResponse
	5,   // 386: weft.v1.WeftAgent.ListAZs:output_type -> weft.v1.ListAZsResponse
	7,   // 387: weft.v1.WeftAgent.GetAZ:output_type -> weft.v1.GetAZResponse
	9,   // 388: weft.v1.WeftAgent.CreateAZ:output_type -> weft.v1.CreateAZResponse
	11,  // 389: weft.v1.WeftAgent.UpdateAZ:output_type -> weft.v1.UpdateAZResponse
	13,  // 390: weft.v1.WeftAgent.DeleteAZ:output_type -> weft.v1.DeleteAZResponse
	16,  // 391: weft.v1.WeftAgent.ListRacks:output_type -> weft.v1.ListRacksResponse
	18,  // 392: weft.v1.WeftAgent.GetRack:output_type -> weft.v1.GetRackResponse
	20,  // 393: weft.v1.WeftAgent.CreateRack:output_type -> weft.v1.CreateRackResponse
	22,  // 394: weft.v1.WeftAgent.UpdateRack:output_type -> weft.v1.UpdateRackResponse
	24,  // 395: weft.v1.WeftAgent.DeleteRack:output_type -> weft.v1.DeleteRackResponse
	27,  // 396: weft.v1.WeftAgent.ListProjects:output_type -> weft.v1.ListProjectsResponse
	29,  // 397: weft.v1.WeftAgent.CreateProject:output_type -> weft.v1.CreateProjectResponse
	31,  // 398: weft.v1.WeftAgent.RenameProject:output_type -> weft.v1.RenameProjectResponse
	33,  // 399: weft.v1.WeftAgent.DeleteProject:output_type -> weft.v1.DeleteProjectResponse
	35,  // 400: weft.v1.WeftAgent.SetProjectTenant:output_type -> weft.v1.SetProjectTenantResponse
	78,  // 401: weft.v1.WeftAgent.AddProjectMember:output_type -> weft.v1.AddProjectMemberResponse
	80,  // 402: weft.v1.WeftAgent.RemoveProjectMember:output_type -> weft.v1.RemoveProjectMemberResponse
	82,  // 403: weft.v1.WeftAgent.ListProjectMembers:output_type -> weft.v1.ListProjectMembersResponse
	85,  // 404: weft.v1.WeftAgent.ListUsers:output_type -> weft.v1.ListUsersResponse
	87,  // 405: weft.v1.WeftAgent.GetUser:output_type -> weft.v1.GetUserResponse
	89,  // 406: weft.v1.WeftAgent.Me:output_type -> weft.v1.MeResponse
	91,  // 407: weft.v1.WeftAgent.SetUserDisplayName:output_type -> weft.v1.SetUserDisplayNameResponse
	93,  // 408: weft.v1.WeftAgent.DeleteUser:output_type -> weft.v1.DeleteUserResponse
	96,  // 409: weft.v1.WeftAgent.ListNetworks:output_type -> weft.v1.ListNetworksResponse
	98,  // 410: weft.v1.WeftAgent.CreateNetwork:output_type -> weft.v1.CreateNetworkResponse
	100, // 411: weft.v1.WeftAgent.RenameNetwork:output_type -> weft.v1.RenameNetworkResponse
	102, // 412: weft.v1.WeftAgent.SetNetworkDNS:output_type -> weft.v1.SetNetworkDNSResponse
	104, // 413: weft.v1.WeftAgent.DeleteNetwork:output_type -> weft.v1.DeleteNetworkResponse
	106, // 414: weft.v1.WeftAgent.SetNetworkDefaultSecurityGroups:output_type -> weft.v1.SetNetworkDefaultSecurityGroupsResponse
	109, // 415: weft.v1.WeftAgent.ListPortsForVM:output_type -> weft.v1.ListPortsForVMResponse
	113, // 416: weft.v1.WeftAgent.ListSecurityGroups:output_type -> weft.v1.ListSecurityGroupsResponse
	115, // 417: weft.v1.WeftAgent.CreateSecurityGroup:output_type -> weft.v1.CreateSecurityGroupResponse
	117, // 418: weft.v1.WeftAgent.RenameSecurityGroup:output_type -> weft.v1.RenameSecurityGroupResponse
	119, // 419: weft.v1.WeftAgent.SetSecurityGroupDescription:output_type -> weft.v1.SetSecurityGroupDescriptionResponse
	121, // 420: weft.v1.WeftAgent.SetSecurityGroupRules:output_type -> weft.v1.SetSecurityGroupRulesResponse
	123, // 421: weft.v1.WeftAgent.DeleteSecurityGroup:output_type -> weft.v1.DeleteSecurityGroupResponse
	126, // 422: weft.v1.WeftAgent.ListVolumes:output_type -> weft.v1.ListVolumesResponse
	128, // 423: weft.v1.WeftAgent.CreateVolume:output_type -> weft.v1.CreateVolumeResponse
	130, // 424: weft.v1.WeftAgent.RenameVolume:output_type -> weft.v1.RenameVolumeResponse
	132, // 425: weft.v1.WeftAgent.ResizeVolume:output_type -> weft.v1.ResizeVolumeResponse
	134, // 426: weft.v1.WeftAgent.AttachVolume:output_type -> weft.v1.AttachVolumeResponse
	136, // 427: weft.v1.WeftAgent.DetachVolume:output_type -> weft.v1.DetachVolumeResponse
	138, // 428: weft.v1.WeftAgent.DeleteVolume:output_type -> weft.v1.DeleteVolumeResponse
	141, // 429: weft.v1.WeftAgent.CreateVolumeSnapshot:output_type -> weft.v1.CreateVolumeSnapshotResponse
	143, // 430: weft.v1.WeftAgent.ListVolumeSnapshots:output_type -> weft.v1.ListVolumeSnapshotsResponse
	145, // 431: weft.v1.WeftAgent.RestoreVolumeSnapshot:output_type -> weft.v1.RestoreVolumeSnapshotResponse
	149, // 432: weft.v1.WeftAgent.RevertVolumeSnapshot:output_type -> weft.v1.RevertVolumeSnapshotResponse
	147, // 433: weft.v1.WeftAgent.DeleteVolumeSnapshot:output_type -> weft.v1.DeleteVolumeSnapshotResponse
	152, // 434: weft.v1.WeftAgent.CreateVolumeBackup:output_type -> weft.v1.CreateVolumeBackupResponse
	154, // 435: weft.v1.WeftAgent.ListVolumeBackups:output_type -> weft.v1.ListVolumeBackupsResponse
	156, // 436: weft.v1.WeftAgent.DeleteVolumeBackup:output_type -> weft.v1.DeleteVolumeBackupResponse
	158, // 437: weft.v1.WeftAgent.RestoreVolumeBackup:output_type -> weft.v1.RestoreVolumeBackupResponse
	159, // 438: weft.v1.WeftAgent.WatchEvents:output_type -> weft.v1.PlatformEvent
	162, // 439: weft.v1.WeftAgent.RenderNATSAuthorization:output_type -> weft.v1.RenderNATSAuthorizationResponse
	203, // 440: weft.v1.WeftAgent.RegisterHost:output_type -> weft.v1.RegisterHostResponse
	205, // 441: weft.v1.WeftAgent.ListHosts:output_type -> weft.v1.ListHostsResponse
	207, // 442: weft.v1.WeftAgent.GetHost:output_type -> weft.v1.GetHostResponse
	209, // 443: weft.v1.WeftAgent.HeartbeatHost:output_type -> weft.v1.HeartbeatHostResponse
	211, // 444: weft.v1.WeftAgent.SetHostState:output_type -> weft.v1.SetHostStateResponse
	213, // 445: weft.v1.WeftAgent.SetHostProperties:output_type -> weft.v1.SetHostPropertiesResponse
	215, // 446: weft.v1.WeftAgent.SetVMProperties:output_type -> weft.v1.SetVMPropertiesResponse
	217, // 447: weft.v1.WeftAgent.SetVMStatus:output_type -> weft.v1.SetVMStatusResponse
	220, // 448: weft.v1.WeftAgent.GetZombieReport:output_type -> weft.v1.GetZombieReportResponse
	220, // 449: weft.v1.WeftAgent.TriggerZombieSweep:output_type -> weft.v1.GetZombieReportResponse
	223, // 450: weft.v1.WeftAgent.SetHostCordoned:output_type -> weft.v1.SetHostCordonedResponse
	225, // 451: weft.v1.WeftAgent.DeleteHost:output_type -> weft.v1.DeleteHostResponse
	169, // 452: weft.v1.WeftAgent.PublishShareToProject:output_type -> weft.v1.PublishShareToProjectResponse
	246, // 453: weft.v1.WeftAgent.ListTenants:output_type -> weft.v1.ListTenantsResponse
	248, // 454: weft.v1.WeftAgent.CreateTenant:output_type -> weft.v1.CreateTenantResponse
	250, // 455: weft.v1.WeftAgent.DeleteTenant:output_type -> weft.v1.DeleteTenantResponse
	252, // 456: weft.v1.WeftAgent.AddTenantAdmin:output_type -> weft.v1.AddTenantAdminResponse
	254, // 457: weft.v1.WeftAgent.RemoveTenantAdmin:output_type -> weft.v1.RemoveTenantAdminResponse
	256, // 458: weft.v1.WeftAgent.AddTenantMember:output_type -> weft.v1.AddTenantMemberResponse
	258, // 459: weft.v1.WeftAgent.RemoveTenantMember:output_type -> weft.v1.RemoveTenantMemberResponse
	261, // 460: weft.v1.WeftAgent.GetTenantQuota:output_type -> weft.v1.GetTenantQuotaResponse
	263, // 461: weft.v1.WeftAgent.SetTenantQuota:output_type -> weft.v1.SetTenantQuotaResponse
	265, // 462: weft.v1.WeftAgent.GetProjectQuota:output_type -> weft.v1.GetProjectQuotaResponse
	267, // 463: weft.v1.WeftAgent.SetProjectQuota:output_type -> weft.v1.SetProjectQuotaResponse
	270, // 464: weft.v1.WeftAgent.ListShares:output_type -> weft.v1.ListSharesResponse
	272, // 465: weft.v1.WeftAgent.CreateShare:output_type -> weft.v1.CreateShareResponse
	274, // 466: weft.v1.WeftAgent.DeleteShare:output_type -> weft.v1.DeleteShareResponse
	277, // 467: weft.v1.WeftAgent.ListFloatingIPs:output_type -> weft.v1.ListFloatingIPsResponse
	279, // 468: weft.v1.WeftAgent.AllocateFloatingIP:output_type -> weft.v1.AllocateFloatingIPResponse
	281, // 469: weft.v1.WeftAgent.ReleaseFloatingIP:output_type -> weft.v1.ReleaseFloatingIPResponse
	283, // 470: weft.v1.WeftAgent.MapFloatingIP:output_type -> weft.v1.MapFloatingIPResponse
	285, // 471: weft.v1.WeftAgent.UnmapFloatingIP:output_type -> weft.v1.UnmapFloatingIPResponse
	288, // 472: weft.v1.WeftAgent.ListFlavors:output_type -> weft.v1.ListFlavorsResponse
	290, // 473: weft.v1.WeftAgent.GetFlavor:output_type -> weft.v1.GetFlavorResponse
	292, // 474: weft.v1.WeftAgent.SetFlavor:output_type -> weft.v1.SetFlavorResponse
	294, // 475: weft.v1.WeftAgent.DeleteFlavor:output_type -> weft.v1.DeleteFlavorResponse
	297, // 476: weft.v1.WeftAgent.ListScripts:output_type -> weft.v1.ListScriptsResponse
	299, // 477: weft.v1.WeftAgent.GetScript:output_type -> weft.v1.GetScriptResponse
	301, // 478: weft.v1.WeftAgent.SetScript:output_type -> weft.v1.SetScriptResponse
	303, // 479: weft.v1.WeftAgent.DeleteScript:output_type -> weft.v1.DeleteScriptResponse
	306, // 480: weft.v1.WeftAgent.ListVMProperties:output_type -> weft.v1.ListVMPropertiesResponse
	308, // 481: weft.v1.WeftAgent.SetVMProperty:output_type -> weft.v1.SetVMPropertyResponse
	310, // 482: weft.v1.WeftAgent.DeleteVMProperty:output_type -> weft.v1.DeleteVMPropertyResponse
	313, // 483: weft.v1.WeftAgent.ListUEFIVars:output_type -> weft.v1.ListUEFIVarsResponse
	315, // 484: weft.v1.WeftAgent.SetUEFIVar:output_type -> weft.v1.SetUEFIVarResponse
	317, // 485: weft.v1.WeftAgent.DeleteUEFIVar:output_type -> weft.v1.DeleteUEFIVarResponse
	320, // 486: weft.v1.WeftAgent.ListVMSSHKeys:output_type -> weft.v1.ListVMSSHKeysResponse
	322, // 487: weft.v1.WeftAgent.AddVMSSHKey:output_type -> weft.v1.AddVMSSHKeyResponse
	324, // 488: weft.v1.WeftAgent.RemoveVMSSHKey:output_type -> weft.v1.RemoveVMSSHKeyResponse
	172, // 489: weft.v1.WeftAgent.ListFederationPeers:output_type -> weft.v1.ListFederationPeersResponse
	177, // 490: weft.v1.WeftAgent.ListPluginCatalogue:output_type -> weft.v1.ListPluginCatalogueResponse
	179, // 491: weft.v1.WeftAgent.ListInstalledPlugins:output_type -> weft.v1.ListInstalledPluginsResponse
	181, // 492: weft.v1.WeftAgent.InstallPlugin:output_type -> weft.v1.InstallPluginResponse
	183, // 493: weft.v1.WeftAgent.UninstallPlugin:output_type -> weft.v1.UninstallPluginResponse
	185, // 494: weft.v1.WeftAgent.EnablePlugin:output_type -> weft.v1.EnablePluginResponse
	187, // 495: weft.v1.WeftAgent.DisablePlugin:output_type -> weft.v1.DisablePluginResponse
	327, // 496: weft.v1.WeftAgent.ListSubnets:output_type -> weft.v1.ListSubnetsResponse
	329, // 497: weft.v1.WeftAgent.GetSubnet:output_type -> weft.v1.GetSubnetResponse
	331, // 498: weft.v1.WeftAgent.CreateSubnet:output_type -> weft.v1.CreateSubnetResponse
	333, // 499: weft.v1.WeftAgent.UpdateSubnet:output_type -> weft.v1.UpdateSubnetResponse
	335, // 500: weft.v1.WeftAgent.DeleteSubnet:output_type -> weft.v1.DeleteSubnetResponse
	339, // 501: weft.v1.WeftAgent.ListLoadBalancers:output_type -> weft.v1.ListLoadBalancersResponse
	341, // 502: weft.v1.WeftAgent.GetLoadBalancer:output_type -> weft.v1.GetLoadBalancerResponse
	343, // 503: weft.v1.WeftAgent.CreateLoadBalancer:output_type -> weft.v1.CreateLoadBalancerResponse
	345, // 504: weft.v1.WeftAgent.UpdateLoadBalancer:output_type -> weft.v1.UpdateLoadBalancerResponse
	347, // 505: weft.v1.WeftAgent.SetLoadBalancerBackends:output_type -> weft.v1.SetLoadBalancerBackendsResponse
	349, // 506: weft.v1.WeftAgent.DeleteLoadBalancer:output_type -> weft.v1.DeleteLoadBalancerResponse
	352, // 507: weft.v1.WeftAgent.ListDNSZones:output_type -> weft.v1.ListDNSZonesResponse
	354, // 508: weft.v1.WeftAgent.GetDNSZone:output_type -> weft.v1.GetDNSZoneResponse
	356, // 509: weft.v1.WeftAgent.CreateDNSZone:output_type -> weft.v1.CreateDNSZoneResponse
	358, // 510: weft.v1.WeftAgent.UpdateDNSZone:output_type -> weft.v1.UpdateDNSZoneResponse
	360, // 511: weft.v1.WeftAgent.DeleteDNSZone:output_type -> weft.v1.DeleteDNSZoneResponse
	363, // 512: weft.v1.WeftAgent.ListDNSRecords:output_type -> weft.v1.ListDNSRecordsResponse
	365, // 513: weft.v1.WeftAgent.CreateDNSRecord:output_type -> weft.v1.CreateDNSRecordResponse
	367, // 514: weft.v1.WeftAgent.UpdateDNSRecord:output_type -> weft.v1.UpdateDNSRecordResponse
	369, // 515: weft.v1.WeftAgent.DeleteDNSRecord:output_type -> weft.v1.DeleteDNSRecordResponse
	372, // 516: weft.v1.WeftAgent.GetVolumeProperty:output_type -> weft.v1.GetVolumePropertyResponse
	374, // 517: weft.v1.WeftAgent.SetVolumeProperty:output_type -> weft.v1.SetVolumePropertyResponse
	376, // 518: weft.v1.WeftAgent.DeleteVolumeProperty:output_type -> weft.v1.DeleteVolumePropertyResponse
	378, // 519: weft.v1.WeftAgent.GetShare:output_type -> weft.v1.GetShareResponse
	380, // 520: weft.v1.WeftAgent.ResizeShare:output_type -> weft.v1.ResizeShareResponse
	383, // 521: weft.v1.WeftAgent.ListBuckets:output_type -> weft.v1.ListBucketsResponse
	385, // 522: weft.v1.WeftAgent.GetBucket:output_type -> weft.v1.GetBucketResponse
	387, // 523: weft.v1.WeftAgent.CreateBucket:output_type -> weft.v1.CreateBucketResponse
	389, // 524: weft.v1.WeftAgent.DeleteBucket:output_type -> weft.v1.DeleteBucketResponse
	391, // 525: weft.v1.WeftAgent.GetBucketPolicy:output_type -> weft.v1.GetBucketPolicyResponse
	393, // 526: weft.v1.WeftAgent.SetBucketPolicy:output_type -> weft.v1.SetBucketPolicyResponse
	396, // 527: weft.v1.WeftAgent.ListSSHKeyCatalogue:output_type -> weft.v1.ListSSHKeyCatalogueResponse
	398, // 528: weft.v1.WeftAgent.AddSSHKeyCatalogue:output_type -> weft.v1.AddSSHKeyCatalogueResponse
	400, // 529: weft.v1.WeftAgent.RemoveSSHKeyCatalogue:output_type -> weft.v1.RemoveSSHKeyCatalogueResponse
	402, // 530: weft.v1.WeftAgent.ImportSSHKeyCatalogue:output_type -> weft.v1.ImportSSHKeyCatalogueResponse
	407, // 531: weft.v1.WeftAgent.ListSchedulingRules:output_type -> weft.v1.ListSchedulingRulesResponse
	409, // 532: weft.v1.WeftAgent.CreateSchedulingRule:output_type -> weft.v1.CreateSchedulingRuleResponse
	411, // 533: weft.v1.WeftAgent.UpdateSchedulingRule:output_type -> weft.v1.UpdateSchedulingRuleResponse
	413, // 534: weft.v1.WeftAgent.DeleteSchedulingRule:output_type -> weft.v1.DeleteSchedulingRuleResponse
	416, // 535: weft.v1.WeftAgent.ListRegistryRemotes:output_type -> weft.v1.ListRegistryRemotesResponse
	418, // 536: weft.v1.WeftAgent.SetRegistryRemote:output_type -> weft.v1.SetRegistryRemoteResponse
	420, // 537: weft.v1.WeftAgent.DeleteRegistryRemote:output_type -> weft.v1.DeleteRegistryRemoteResponse
	422, // 538: weft.v1.WeftAgent.SearchRegistryRemote:output_type -> weft.v1.SearchRegistryRemoteResponse
	189, // 539: weft.v1.WeftAgent.SetPodSpec:output_type -> weft.v1.SetPodSpecResponse
	191, // 540: weft.v1.WeftAgent.GetPodSpec:output_type -> weft.v1.GetPodSpecResponse
	193, // 541: weft.v1.WeftAgent.GetMicroVMMetrics:output_type -> weft.v1.MicroVMMetricsResponse
	195, // 542: weft.v1.WeftAgent.GetClusterInfo:output_type -> weft.v1.GetClusterInfoResponse
	197, // 543: weft.v1.WeftAgent.SetClusterName:output_type -> weft.v1.SetClusterNameResponse
	227, // 544: weft.v1.AgentDispatch.Connect:output_type -> weft.v1.ControlMessage
	423, // 545: weft.v1.AttestationService.Enroll:output_type -> weft.v1.AttestMsg
	424, // 546: weft.v1.AttestationService.CompleteEnroll:output_type -> weft.v1.AttestResult
	423, // 547: weft.v1.AttestationService.RequestAdmission:output_type -> weft.v1.AttestMsg
	425, // 548: weft.v1.AttestationService.Admit:output_type -> weft.v1.AdmitResult
	368, // [368:549] is the sub-list for method output_type
	187, // [187:368] is the sub-list for method input_type
...
func file_weft_proto_init() {
	...
	file_weft_proto_msgTypes[231].OneofWrappers = []any{
